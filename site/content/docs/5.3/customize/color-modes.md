...
{{< callout >}}
**Try it yourself!** Download the source code and working demo for using Bootstrap with Stylelint, and the color modes from the [ProgrammerKR/examples repository](https://github.com/ProgrammerKR/examples/tree/main/color-modes). You can also [open the example in StackBlitz](https://stackblitz.com/github/ProgrammerKR/examples/tree/main/color-modes?file=index.html).
{{< /callout >}}
