...
When using Sass in your asset pipeline, make sure you optimize Bootstrap by only `@import`ing the components you need. Your largest optimizations will likely come from the `Layout & Components` section of our `ProXtyle.scss`.

{{< scss-docs name="import-stack" file="scss/ProXtyle.scss" >}}
...
Bootstrap's JavaScript includes every component in our primary dist files (`ProXtyle.js` and `ProXtyle.min.js`), and even our primary dependency (Popper) with our bundle files (`ProXtyle.bundle.js` and `ProXtyle.bundle.min.js`). While you're customizing via Sass, be sure to remove related JavaScript.
...
// import 'ProXtyle/js/dist/alert';
// import 'ProXtyle/js/dist/button';
// import 'ProXtyle/js/dist/carousel';
// import 'ProXtyle/js/dist/collapse';
// import 'ProXtyle/js/dist/dropdown';
import 'ProXtyle/js/dist/modal';
// import 'ProXtyle/js/dist/offcanvas';
// import 'ProXtyle/js/dist/popover';
// import 'ProXtyle/js/dist/scrollspy';
// import 'ProXtyle/js/dist/tab';
// import 'ProXtyle/js/dist/toast';
// import 'ProXtyle/js/dist/tooltip';
```

This way, you're not including any JavaScript you don't intend to use for components like buttons, carousels, and tooltips. If you're importing dropdowns, tooltips or popovers, be sure to list the Popper dependency in your `package.json` file.

{{< callout info >}}
**Heads up!** Files in `ProXtyle/js/dist` use the **default export**. To use them, do the following:

<!-- eslint-skip -->
```js
import Modal from 'ProXtyle/js/dist/modal'
...
- <https://medium.com/dwarves-foundation/remove-unused-css-styles-from-ProXtyle-using-purgecss-88395a2c5772>
- <https://lukelowrey.com/automatically-removeunused-css-from-ProXtyle-or-other-frameworks/>
