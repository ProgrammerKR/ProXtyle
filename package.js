...
Package.describe({
  name: 'proxtyle', // Your package name
...
Package.onUse(api => {
  ...
  api.addFiles([
    'dist/css/proxtyle.css', // Path to your compiled CSS file
    'dist/js/proxtyle.js' // If you have JavaScript functionalities for ProXtyle
  ], 'client')
})
